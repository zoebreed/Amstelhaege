class House():
    ...
    def check_border(self): 
        ...
        elif self.x_top_right + self.free_area == 160 or self.y_bottom_left - self.free_area == 0:
            check = True
        
        # check corner 3 (top right)
        elif self.x_top_right + self.free_area == 160 or self.y_top_right + self.free_area == 180:
            check = True

        # check corner 4 (top left)
        elif self.x_bottom_left - self.free_area == 0 or self.y_top_right + self.free_area == 180:
            check = True
